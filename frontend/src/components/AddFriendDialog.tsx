...
export interface AddFriendDialogRef {
  open: () => void;
}

const AddFriendDialog = forwardRef<AddFriendDialogRef, AddFriendDialogProps>(
  ({ onFriendRequestSent, initialOpen = false }, ref) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
      ...
      try {
        ...
        if (result.error) {
          ...
          toast.success(
            result.message || `Friend request sent to ${username}!`
          );
          setUsername("");
